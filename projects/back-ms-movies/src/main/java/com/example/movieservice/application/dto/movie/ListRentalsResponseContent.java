...
/**
 * Data Transfer Object for ListRentalsResponseContent.
 * <p>
...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Data Transfer Object for ListRentalsResponseContent")
public class ListRentalsResponseContent {

    @NotNull
    @JsonProperty("rentals")
    @Schema(description = "rentals field")
