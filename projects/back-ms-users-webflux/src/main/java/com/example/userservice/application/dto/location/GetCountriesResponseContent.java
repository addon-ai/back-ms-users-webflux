...
/**
 * Data Transfer Object for GetCountriesResponseContent.
 * <p>
...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Data Transfer Object for GetCountriesResponseContent")
public class GetCountriesResponseContent {

    @NotNull
    @JsonProperty("countries")
    @Schema(description = "countries field")
