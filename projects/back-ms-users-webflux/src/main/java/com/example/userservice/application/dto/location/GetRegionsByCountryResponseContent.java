...
/**
 * Data Transfer Object for GetRegionsByCountryResponseContent.
 * <p>
...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Data Transfer Object for GetRegionsByCountryResponseContent")
public class GetRegionsByCountryResponseContent {

    @NotNull
    @JsonProperty("regions")
    @Schema(description = "regions field")
